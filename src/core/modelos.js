...
/* Componentes da marca. É o que faltava para os slides parecerem com o
   design real: o formato do rótulo, o acabamento dos cartões e o bloco de
   mídia das marcas orientadas a imagem. */
const COMP_PADRAO = {
  chip: "nenhum",      // nenhum | pill | solido | barra | quadro
  sombra: 0,           // 0 a 3
  mediaCapa: false,    // capa com bloco de mídia ao lado do título
  mediaRaio: null,
};
...
export const MODELOS_ARQUIVO = [
  mk({ id: "airbnb", comp: { ...COMP_PADRAO, chip: "pill", sombra: 2, mediaCapa: true, mediaRaio: 20 }, nome: "Airbnb", arquivo: "DESIGN-airbnb.md", desc: "Branco acolhedor, vermelho coral e cantos generosos.",
    fg: "#222222", muted: "#6a6a6a", accent: "#ff385c", surface: "#f7f7f7", hairline: "#dddddd", wTitle: 600, radius: 20, cartao: "borda" }),
  mk({ id: "airtable", comp: { ...COMP_PADRAO, chip: "solido", sombra: 0 }, nome: "Airtable", arquivo: "DESIGN-airtable.md", desc: "Tinta escura e cartões assinatura em coral, verde e pêssego.",
  ...
  mk({ id: "binance", comp: { ...COMP_PADRAO, chip: "solido", sombra: 0 }, nome: "Binance", arquivo: "DESIGN-binance.md", desc: "Fundo quase preto com amarelo intenso como único destaque.",
    bg: "#0b0e11", fg: "#eaecef", muted: "#707a8a", accent: "#fcd535", surface: "#1e2329", hairline: "#2b3139", radius: 8, deco: "glow", glowA: 0.2 }),
  mk({ id: "bmw-m", comp: { ...COMP_PADRAO, chip: "barra", sombra: 0 }, nome: "BMW M", arquivo: "DESIGN-bmw-m.md", desc: "Preto absoluto, caixa alta e as três faixas de competição.",
  ...
  mk({ id: "bmw", comp: { ...COMP_PADRAO, chip: "barra", sombra: 1 }, nome: "BMW", arquivo: "DESIGN-bmw.md", desc: "Corporativo automotivo: azul, painel escuro e dois pesos.",
    fg: "#262626", muted: "#6b6b6b", accent: "#1c69d4", surface: "#f7f7f7", hairline: "#e6e6e6", track: 0, wBody: 300, radius: 4,
    capa: "painel", painel: "#1a2129" }),
  mk({ id: "bugatti", comp: { ...COMP_PADRAO, chip: "nenhum", sombra: 0 }, nome: "Bugatti", arquivo: "DESIGN-bugatti.md", desc: "Luxo austero: preto, caixa alta espaçada e serifa clássica.",
  ...
  mk({ id: "coinbase", comp: { ...COMP_PADRAO, chip: "pill", sombra: 1 }, nome: "Coinbase", arquivo: "DESIGN-coinbase.md", desc: "Branco institucional, azul único e títulos grandes e leves.",
    fg: "#0a0b0d", muted: "#5b616e", accent: "#0052ff", surface: "#eef0f3", hairline: "#dee1e6", wTitle: 400, track: -0.03, radius: 16 }),
  mk({ id: "cursor", comp: { ...COMP_PADRAO, chip: "quadro", sombra: 1 }, nome: "Cursor", arquivo: "DESIGN-cursor.md", desc: "Papel creme editorial, tinta quente e laranja vivo.",
  ...
  mk({ id: "dell-1996", comp: { ...COMP_PADRAO, chip: "solido", sombra: 0 }, nome: "Dell 1996", arquivo: "DESIGN-dell-1996.md", desc: "Catálogo anos 90: moldura preta, faixas coloridas e Arial Black.",
  ...
  mk({ id: "discord", comp: { ...COMP_PADRAO, chip: "pill", sombra: 2 }, nome: "Discord", arquivo: "DESIGN-discord.md", desc: "Índigo profundo, gradiente blurple e magenta, títulos largos.",
  ...
  mk({ id: "figma", comp: { ...COMP_PADRAO, chip: "quadro", sombra: 0, mediaCapa: true, mediaRaio: 24 }, nome: "Figma", arquivo: "DESIGN-figma.md", desc: "Preto e branco interrompido por blocos pastel recortados.",
  ...
  mk({ id: "kraken", comp: { ...COMP_PADRAO, chip: "pill", sombra: 1 }, nome: "Kraken", arquivo: "DESIGN-kraken.md", desc: "Branco confiável com roxo marcante e cantos de 12px.",
    fg: "#101114", muted: "#686b82", accent: "#7132f5", surface: "#f0ebff", hairline: "#dedee5", fTitle: "IBM Plex Sans", fBody: "IBM Plex Sans", radius: 12 }),
  mk({ id: "lovable", comp: { ...COMP_PADRAO, chip: "quadro", sombra: 1 }, nome: "Lovable", arquivo: "DESIGN-lovable.md", desc: "Creme pergaminho, carvão quente e tipografia humanista.",
  ...
  mk({ id: "mobbin", comp: { ...COMP_PADRAO, chip: "pill", sombra: 1, mediaCapa: true, mediaRaio: 24 }, nome: "Mobbin", arquivo: "DESIGN-mobbin.md", desc: "Galeria branca monocromática, pílulas e cantos de 24px.",
  ...
  mk({ id: "pinterest", comp: { ...COMP_PADRAO, chip: "pill", sombra: 0 }, nome: "Pinterest", arquivo: "DESIGN-pinterest.md", desc: "Mosaico de imagens, vermelho vivo e neutros quentes.",
  ...
  mk({ id: "raycast", comp: { ...COMP_PADRAO, chip: "quadro", sombra: 2 }, nome: "Raycast", arquivo: "DESIGN-raycast.md", desc: "Preto de produto, bordas finas e faixas vermelhas diagonais.",
  ...
  mk({ id: "vodafone", comp: { ...COMP_PADRAO, chip: "solido", sombra: 0 }, nome: "Vodafone", arquivo: "DESIGN-vodafone.md", desc: "Cartaz de campanha: caixa alta pesadíssima e vermelho escarlate.",
